(function() {
     // Step one: mobile detect.
     // Set the .className of the element (document.body) based on whether the
     // screen is mobile or in landscape. Regular gives "desktop", vertical
     // mobile gives "mobile", and landscape mobile gives "tablet".
